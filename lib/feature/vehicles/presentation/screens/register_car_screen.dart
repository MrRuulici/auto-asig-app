...
class _RegisterCarScreenState extends State<RegisterCarScreen> {
  ...
  late final FocusNode nrCarFocusNode;
  late final FocusNode vehicleModelFocusNode;
  ...
  void initState() {
    ...
    nrCarFocusNode = FocusNode();
    vehicleModelFocusNode = FocusNode();
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        nrCarFocusNode.unfocus();
        vehicleModelFocusNode.unfocus();
              ...
              child: Column(
                ...
                children: [
                  ...
                  ExpirationSection(
                    ...
                    updateNotificationPeriods: (index, monthBefore, weekBefore,
